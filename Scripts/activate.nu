...
let virtual-env = "C:\Distrib\Искуственный интелект\GIT\Intensive"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "C:\Distrib\Искуственный интелект\GIT\Intensive\Scripts\deactivate.nu"
